                ...
                <div class="card text-bg-light mb-3">
                    <a href="https://github.com/choijung121/portfolio" className="card-text">
                        ...
                        <div class="card-body">
                            ...
                            <a href="" class="link-dark icon-link">
            ...
            <div class="col-sm-3">
                <div class="card text-bg-light mb-3">
                    <a href="https://github.com/choijung121/weatherapp" className="card-text">
                        <img src={weatherApp} class="card-img-top" alt="Example of Weather App"/>
                        <div class="card-body">
                            <h5 class="card-title">Weather App</h5>
                            <p class="card-text">Simple searchable weather app to get information on temperature and other informations</p>
